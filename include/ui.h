 ...
 * 
 * This function creates a screen that displays detailed information about a star,
 * including its name, right ascension, declination, magnitude, spectral type,
 * constellation, and B-V color index. It also includes a button to return to the
 * previous screen.
 * 
